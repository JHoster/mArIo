...
import mArIoDSL.generator.MyDslGenerator;
import mArIoDSL.parser.antlr.MyDslAntlrTokenFileProvider;
import mArIoDSL.parser.antlr.MyDslParser;
import mArIoDSL.parser.antlr.internal.InternalMyDslLexer;
import mArIoDSL.scoping.MyDslScopeProvider;
import mArIoDSL.serializer.MyDslSemanticSequencer;
import mArIoDSL.serializer.MyDslSyntacticSequencer;
import mArIoDSL.services.MyDslGrammarAccess;
import mArIoDSL.validation.MyDslConfigurableIssueCodesProvider;
import mArIoDSL.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "mArIoDSL/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("mArIoDSL.MyDsl");
	}
